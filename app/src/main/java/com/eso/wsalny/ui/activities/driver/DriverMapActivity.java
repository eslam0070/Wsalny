...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    CircleImageView profileImageCustomer;
    TextView nameCustomer, phoneCustomer,carNameDriver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SettingsDriverButton.setOnClickListener(view -> {
        ...
        profileImageCustomer = findViewById(R.id.profile_image_customer);
        ...
        if(getApplicationContext() != null)
        {
            ...
            switch (customerID)
            {
                case "":
                    ...
                    geoFireAvailability.setLocation(userID, new GeoLocation(location.getLatitude(), location.getLongitude()),(key, error) -> {});
                    break;

                default:
                    geoFireAvailability.removeLocation(userID, (key, error) -> {});
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    ...
                    if (dataSnapshot.hasChild("image")) {
                        ...
                        Glide.with(DriverMapActivity.this).load(image).placeholder(R.drawable.profile).into(profileImageCustomer);
                    }
                }
            }
